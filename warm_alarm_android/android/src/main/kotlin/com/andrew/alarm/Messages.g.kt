...
enum class WarmAlarmSupportStatusWire(val raw: Int) {
  SUPPORTED(0),
  LIMITED(1),
  UNSUPPORTED(2),
  UNKNOWN(3);
  ...
  companion object {
    fun ofRaw(raw: Int): WarmAlarmSupportStatusWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}

enum class WarmAlarmReadinessLevelWire(val raw: Int) {
  READY(0),
  LIMITED(1),
  BLOCKED(2),
  UNSUPPORTED(3);
  ...
  companion object {
    fun ofRaw(raw: Int): WarmAlarmReadinessLevelWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}

enum class WarmAlarmReadinessReasonWire(val raw: Int) {
  ...
  companion object {
    fun ofRaw(raw: Int): WarmAlarmReadinessReasonWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}

enum class WarmAlarmRemediationStatusWire(val raw: Int) {
  COMPLETED(0),
  UNAVAILABLE(1),
  UNSUPPORTED(2);

  companion object {
    fun ofRaw(raw: Int): WarmAlarmRemediationStatusWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}

enum class WarmAlarmFailureCodeWire(val raw: Int) {
  UNKNOWN(0),
  INVALID_ARGUMENTS(1),
  PERMISSION_DENIED(2),
  ...
  companion object {
    fun ofRaw(raw: Int): WarmAlarmFailureCodeWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}

enum class WarmAlarmEventTypeWire(val raw: Int) {
  SCHEDULED(0),
  FIRED(1),
  STOPPED(2),
  SNOOZED(3),
  ...
  companion object {
    fun ofRaw(raw: Int): WarmAlarmEventTypeWire? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmCapabilitiesWire {
      ...
      return WarmAlarmCapabilitiesWire(exactScheduling, notificationScheduling, backgroundAudioPlayback, fullScreenPresentation, wakeCheck, liveActivity)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.exactScheduling, other.exactScheduling) && MessagesPigeonUtils.deepEquals(this.notificationScheduling, other.notificationScheduling) && MessagesPigeonUtils.deepEquals(this.backgroundAudioPlayback, other.backgroundAudioPlayback) && MessagesPigeonUtils.deepEquals(this.fullScreenPresentation, other.fullScreenPresentation) && MessagesPigeonUtils.deepEquals(this.wakeCheck, other.wakeCheck) && MessagesPigeonUtils.deepEquals(this.liveActivity, other.liveActivity)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmCapabilitiesWire(exactScheduling=$exactScheduling, notificationScheduling=$notificationScheduling, backgroundAudioPlayback=$backgroundAudioPlayback, fullScreenPresentation=$fullScreenPresentation, wakeCheck=$wakeCheck, liveActivity=$liveActivity)"
  }
}
...
data class WarmAlarmPermissionStateWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.notificationsGranted, other.notificationsGranted) && MessagesPigeonUtils.deepEquals(this.exactAlarmGranted, other.exactAlarmGranted) && MessagesPigeonUtils.deepEquals(this.fullScreenIntentGranted, other.fullScreenIntentGranted)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmPermissionStateWire(notificationsGranted=$notificationsGranted, exactAlarmGranted=$exactAlarmGranted, fullScreenIntentGranted=$fullScreenIntentGranted)"
  }
}
...
/** Generated class from Pigeon that represents data sent in messages. */
data class WarmAlarmRemediationResultWire (
  val status: WarmAlarmRemediationStatusWire,
  val permissionState: WarmAlarmPermissionStateWire,
  val readiness: WarmAlarmReadinessWire
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmRemediationResultWire {
      val status = pigeonVar_list[0] as WarmAlarmRemediationStatusWire
      val permissionState = pigeonVar_list[1] as WarmAlarmPermissionStateWire
      val readiness = pigeonVar_list[2] as WarmAlarmReadinessWire
      return WarmAlarmRemediationResultWire(status, permissionState, readiness)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as WarmAlarmRemediationResultWire
    return MessagesPigeonUtils.deepEquals(this.status, other.status) && MessagesPigeonUtils.deepEquals(this.permissionState, other.permissionState) && MessagesPigeonUtils.deepEquals(this.readiness, other.readiness)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.status)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.permissionState)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.readiness)
    return result
  }
  override fun toString(): String {
    return "WarmAlarmRemediationResultWire(status=$status, permissionState=$permissionState, readiness=$readiness)"
  }
}
...
data class WarmAlarmFailureWire (
...
)
 {
  ...
  override fun toString(): String {
    return "WarmAlarmFailureWire(code=$code, message=$message)"
  }
}
...
data class WarmAlarmScheduleResultWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.alarmId, other.alarmId) && MessagesPigeonUtils.deepEquals(this.readiness, other.readiness) && MessagesPigeonUtils.deepEquals(this.warning, other.warning)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmScheduleResultWire(alarmId=$alarmId, readiness=$readiness, warning=$warning)"
  }
}
...
data class WarmAlarmNotificationWire (
  ...
  val androidIcon: String? = null,
  val androidIconColor: Long? = null,
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmNotificationWire {
      ...
      val androidIcon = pigeonVar_list[4] as String?
      val androidIconColor = pigeonVar_list[5] as Long?
      val keepNotificationAfterAlarmEnds = pigeonVar_list[6] as Boolean
      return WarmAlarmNotificationWire(title, body, stopActionTitle, snoozeActionTitle, androidIcon, androidIconColor, keepNotificationAfterAlarmEnds)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.title, other.title) && MessagesPigeonUtils.deepEquals(this.body, other.body) && MessagesPigeonUtils.deepEquals(this.stopActionTitle, other.stopActionTitle) && MessagesPigeonUtils.deepEquals(this.snoozeActionTitle, other.snoozeActionTitle) && MessagesPigeonUtils.deepEquals(this.androidIcon, other.androidIcon) && MessagesPigeonUtils.deepEquals(this.androidIconColor, other.androidIconColor) && MessagesPigeonUtils.deepEquals(this.keepNotificationAfterAlarmEnds, other.keepNotificationAfterAlarmEnds)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.androidIcon)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.androidIconColor)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.keepNotificationAfterAlarmEnds)
    return result
  }
  override fun toString(): String {
    return "WarmAlarmNotificationWire(title=$title, body=$body, stopActionTitle=$stopActionTitle, snoozeActionTitle=$snoozeActionTitle, androidIcon=$androidIcon, androidIconColor=$androidIconColor, keepNotificationAfterAlarmEnds=$keepNotificationAfterAlarmEnds)"
  }
}

/** Generated class from Pigeon that represents data sent in messages. */
data class WarmAlarmVolumeFadeStepWire (
  val timeMillis: Long,
  val volume: Double
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmVolumeFadeStepWire {
      val timeMillis = pigeonVar_list[0] as Long
      val volume = pigeonVar_list[1] as Double
      return WarmAlarmVolumeFadeStepWire(timeMillis, volume)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as WarmAlarmVolumeFadeStepWire
    return MessagesPigeonUtils.deepEquals(this.timeMillis, other.timeMillis) && MessagesPigeonUtils.deepEquals(this.volume, other.volume)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.timeMillis)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.volume)
    return result
  }
  override fun toString(): String {
    return "WarmAlarmVolumeFadeStepWire(timeMillis=$timeMillis, volume=$volume)"
  }
}
...
data class WarmAlarmAudioWire (
  ...
  val fadeSteps: List<WarmAlarmVolumeFadeStepWire>? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmAudioWire {
      ...
      val volumeEnforced = pigeonVar_list[6] as Boolean
      val fadeSteps = pigeonVar_list[7] as List<WarmAlarmVolumeFadeStepWire>?
      return WarmAlarmAudioWire(filePath, assetPath, loop, volume, fadeInDurationMillis, vibrate, volumeEnforced, fadeSteps)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.filePath, other.filePath) && MessagesPigeonUtils.deepEquals(this.assetPath, other.assetPath) && MessagesPigeonUtils.deepEquals(this.loop, other.loop) && MessagesPigeonUtils.deepEquals(this.volume, other.volume) && MessagesPigeonUtils.deepEquals(this.fadeInDurationMillis, other.fadeInDurationMillis) && MessagesPigeonUtils.deepEquals(this.vibrate, other.vibrate) && MessagesPigeonUtils.deepEquals(this.volumeEnforced, other.volumeEnforced) && MessagesPigeonUtils.deepEquals(this.fadeSteps, other.fadeSteps)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.volumeEnforced)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.fadeSteps)
    return result
  }
  override fun toString(): String {
    return "WarmAlarmAudioWire(filePath=$filePath, assetPath=$assetPath, loop=$loop, volume=$volume, fadeInDurationMillis=$fadeInDurationMillis, vibrate=$vibrate, volumeEnforced=$volumeEnforced, fadeSteps=$fadeSteps)"
  }
}
...
data class WarmAlarmRecurrenceWire (
...
)
 {
  ...
  override fun toString(): String {
    return "WarmAlarmRecurrenceWire(weekdays=$weekdays)"
  }
}
...
data class WarmAlarmSnoozeWire (
...
)
 {
  ...
  override fun toString(): String {
    return "WarmAlarmSnoozeWire(durationMillis=$durationMillis)"
  }
}
...
data class WarmAlarmWakeCheckWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.checkDelayMillis, other.checkDelayMillis) && MessagesPigeonUtils.deepEquals(this.retriggerDelayMillis, other.retriggerDelayMillis) && MessagesPigeonUtils.deepEquals(this.maxRetriggers, other.maxRetriggers)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmWakeCheckWire(checkDelayMillis=$checkDelayMillis, retriggerDelayMillis=$retriggerDelayMillis, maxRetriggers=$maxRetriggers)"
  }
}
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmScheduleWire {
      ...
      return WarmAlarmScheduleWire(id, scheduledAtMillis, notification, audio, recurrence, snooze, wakeCheck, payload, androidFullScreenIntent)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.id, other.id) && MessagesPigeonUtils.deepEquals(this.scheduledAtMillis, other.scheduledAtMillis) && MessagesPigeonUtils.deepEquals(this.notification, other.notification) && MessagesPigeonUtils.deepEquals(this.audio, other.audio) && MessagesPigeonUtils.deepEquals(this.recurrence, other.recurrence) && MessagesPigeonUtils.deepEquals(this.snooze, other.snooze) && MessagesPigeonUtils.deepEquals(this.wakeCheck, other.wakeCheck) && MessagesPigeonUtils.deepEquals(this.payload, other.payload) && MessagesPigeonUtils.deepEquals(this.androidFullScreenIntent, other.androidFullScreenIntent)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmScheduleWire(id=$id, scheduledAtMillis=$scheduledAtMillis, notification=$notification, audio=$audio, recurrence=$recurrence, snooze=$snooze, wakeCheck=$wakeCheck, payload=$payload, androidFullScreenIntent=$androidFullScreenIntent)"
  }
}
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WarmAlarmSnapshotWire {
      ...
      val payload = pigeonVar_list[7] as String?
      val androidFullScreenIntent = pigeonVar_list[8] as Boolean
      return WarmAlarmSnapshotWire(id, scheduledAtMillis, notification, audio, recurrence, snooze, wakeCheck, payload, androidFullScreenIntent)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun toString(): String {
    return "WarmAlarmSnapshotWire(id=$id, scheduledAtMillis=$scheduledAtMillis, notification=$notification, audio=$audio, recurrence=$recurrence, snooze=$snooze, wakeCheck=$wakeCheck, payload=$payload, androidFullScreenIntent=$androidFullScreenIntent)"
  }
}
...
data class WarmAlarmEventWire (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.alarmId, other.alarmId) && MessagesPigeonUtils.deepEquals(this.type, other.type) && MessagesPigeonUtils.deepEquals(this.occurredAtMillis, other.occurredAtMillis) && MessagesPigeonUtils.deepEquals(this.snoozeDurationMillis, other.snoozeDurationMillis) && MessagesPigeonUtils.deepEquals(this.failure, other.failure) && MessagesPigeonUtils.deepEquals(this.payload, other.payload)
  }
  ...
  override fun toString(): String {
    return "WarmAlarmEventWire(alarmId=$alarmId, type=$type, occurredAtMillis=$occurredAtMillis, snoozeDurationMillis=$snoozeDurationMillis, failure=$failure, payload=$payload)"
  }
}
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      132.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          WarmAlarmRemediationStatusWire.ofRaw(it.toInt())
        }
      }
      133.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
      ...
      138.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          WarmAlarmRemediationResultWire.fromList(it)
        }
      }
      139.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
      ...
      143.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          WarmAlarmVolumeFadeStepWire.fromList(it)
        }
      }
      144.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is WarmAlarmRemediationStatusWire -> {
        stream.write(132)
        writeValue(stream, value.raw.toLong())
      }
      ...
      is WarmAlarmRemediationResultWire -> {
        stream.write(138)
        writeValue(stream, value.toList())
      }
      ...
      is WarmAlarmVolumeFadeStepWire -> {
        stream.write(143)
        writeValue(stream, value.toList())
      }
...
interface WarmAlarmApi {
  ...
  fun requestNotificationPermission(callback: (Result<WarmAlarmRemediationResultWire>) -> Unit)
  fun openReadinessSettings(reason: WarmAlarmReadinessReasonWire, callback: (Result<WarmAlarmRemediationResultWire>) -> Unit)
  fun scheduleAlarm(schedule: WarmAlarmScheduleWire, callback: (Result<WarmAlarmScheduleResultWire>) -> Unit)
  fun cancelAlarm(id: Long, callback: (Result<Unit>) -> Unit)
  fun cancelAllAlarms(callback: (Result<Unit>) -> Unit)
  fun getScheduledAlarms(callback: (Result<List<WarmAlarmSnapshotWire>>) -> Unit)
  fun isRinging(alarmId: Long?, callback: (Result<Boolean>) -> Unit)
  fun setKillWarning(title: String, body: String, callback: (Result<Unit>) -> Unit)
  fun clearKillWarning(callback: (Result<Unit>) -> Unit)
  ...
  companion object {
    ...
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: WarmAlarmApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.initialize$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.getCapabilities$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.getPermissionState$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.getReadiness$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.requestNotificationPermission$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.requestNotificationPermission{ result: Result<WarmAlarmRemediationResultWire> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.openReadinessSettings$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val reasonArg = args[0] as WarmAlarmReadinessReasonWire
            api.openReadinessSettings(reasonArg) { result: Result<WarmAlarmRemediationResultWire> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.scheduleAlarm$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.cancelAlarm$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.cancelAllAlarms$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.getScheduledAlarms$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.isRinging$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.setKillWarning$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val titleArg = args[0] as String
            val bodyArg = args[1] as String
            api.setKillWarning(titleArg, bodyArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.warm_alarm.WarmAlarmApi.clearKillWarning$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.clearKillWarning{ result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
...
class WarmAlarmEventsApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
  ...
  fun emitEvent(eventArg: WarmAlarmEventWire, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
