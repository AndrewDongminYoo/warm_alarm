...
struct WarmAlarmReadinessWire: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: WarmAlarmReadinessWire, rhs: WarmAlarmReadinessWire) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.level, rhs.level) && MessagesPigeonInternal.deepEquals(lhs.reasons, rhs.reasons)
  }
  ...
  public var description: String {
    return "WarmAlarmReadinessWire(level: \(String(describing: level)), reasons: \(String(describing: reasons)))"
  }
}
...
struct WarmAlarmAudioWire: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: WarmAlarmAudioWire, rhs: WarmAlarmAudioWire) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.filePath, rhs.filePath) && MessagesPigeonInternal.deepEquals(lhs.assetPath, rhs.assetPath) && MessagesPigeonInternal.deepEquals(lhs.loop, rhs.loop) && MessagesPigeonInternal.deepEquals(lhs.volume, rhs.volume) && MessagesPigeonInternal.deepEquals(lhs.fadeInDurationMillis, rhs.fadeInDurationMillis) && MessagesPigeonInternal.deepEquals(lhs.vibrate, rhs.vibrate) && MessagesPigeonInternal.deepEquals(lhs.volumeEnforced, rhs.volumeEnforced) && MessagesPigeonInternal.deepEquals(lhs.fadeSteps, rhs.fadeSteps)
  }
...
struct WarmAlarmSnapshotWire: Hashable, CustomStringConvertible {
  ...
  public var description: String {
    return "WarmAlarmSnapshotWire(id: \(String(describing: id)), scheduledAtMillis: \(String(describing: scheduledAtMillis)), notification: \(String(describing: notification)), audio: \(String(describing: audio)), recurrence: \(String(describing: recurrence)), snooze: \(String(describing: snooze)), payload: \(String(describing: payload)))"
  }
}
